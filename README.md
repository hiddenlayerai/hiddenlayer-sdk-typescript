...
```sh
npm install git+ssh://git@github.com:stainless-sdks/hiddenlayer-sdk-typescript.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/hiddenlayer-sdk-typescript/issues) with questions, bugs, or suggestions.

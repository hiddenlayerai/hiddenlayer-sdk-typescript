...
```sh
git clone git@github.com:hiddenlayer-engineering/hiddenlayer-sdk-typescript.git
...
export HIDDEN_LAYER_ENVIRONMENT="prod-us"
  ...
  "mcpServers": {
    "hiddenlayer_api": {
      ...
      "env": {
        ...
        "HIDDEN_LAYER_ENVIRONMENT": "prod-us"
      }
    }
  }
}
...
| --------------------- | ------------------------ | --------------- |
| `x-hiddenlayer-token` | `bearerToken` | BearerAuth |

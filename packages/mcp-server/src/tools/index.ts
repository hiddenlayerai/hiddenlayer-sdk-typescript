...
import create_prompt_analyzer from './prompt-analyzer/create-prompt-analyzer';
import retrieve_model_intel_files from './model-intel/files/retrieve-model-intel-files';
import get_metadata_model_intel_files from './model-intel/files/get-metadata-model-intel-files';
import create_sensors from './sensors/create-sensors';
import retrieve_sensors from './sensors/retrieve-sensors';
import update_sensors from './sensors/update-sensors';
import delete_sensors from './sensors/delete-sensors';
import query_sensors from './sensors/query-sensors';
import retrieve_scans_jobs from './scans/jobs/retrieve-scans-jobs';
...
addEndpoint(create_prompt_analyzer);
addEndpoint(retrieve_model_intel_files);
addEndpoint(get_metadata_model_intel_files);
addEndpoint(create_sensors);
addEndpoint(retrieve_sensors);
addEndpoint(update_sensors);
addEndpoint(delete_sensors);
addEndpoint(query_sensors);
addEndpoint(retrieve_scans_jobs);

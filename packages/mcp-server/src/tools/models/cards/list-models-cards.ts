...
export const handler = async (client: HiddenLayer, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.models.cards.list(body).asResponse();

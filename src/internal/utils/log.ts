...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: HiddenLayer): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: HiddenLayer): Logger {

...
describe('resource redTeam', () => {
  ...
  test.skip('submitTargetResponse: only required params', async () => {
    const responsePromise = client.evaluations.redTeam.submitTargetResponse('workflow_id', { session_id: 'session_id', target_response: 'target_response' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('submitTargetResponse: required and optional params', async () => {
    const response = await client.evaluations.redTeam.submitTargetResponse('workflow_id', { session_id: 'session_id', target_response: 'target_response' });
  });

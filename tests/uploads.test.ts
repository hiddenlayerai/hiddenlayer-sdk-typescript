import fs from 'fs';
import type { ResponseLike } from '@hiddenlayerai/hiddenlayer-sdk/internal/to-file';
import { toFile } from '@hiddenlayerai/hiddenlayer-sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@hiddenlayerai/hiddenlayer-sdk/core/uploads');
    await expect(
